package ComputerNetworks.clientServer.Client2;
    ...
    void runClient(){
        try {
            ...
            try {
                ...
                while (true) {
                    System.out.println("This is client2 ,Enter a command enter STOP to exit");
                    Scanner sc = new Scanner(System.in);
                    String command = sc.nextLine();
                    if (command.equalsIgnoreCase("stop")) break;
                    String[] strings = Utils.splitIt(command);
                    ...
                    System.out.println("way to send is: "+wayToSend);
